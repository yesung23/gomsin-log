...
export function InstallPromptBanner() {
  ...
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-1/2 w-[calc(100%-2.5rem)] max-w-[390px] z-50 bg-white/95 backdrop-blur-xl p-5 rounded-3xl shadow-2xl border border-gray-100 animate-in slide-in-from-bottom-8">
