...
export function SharedSyncBanner() {
  ...
  return (
    <div
      className="mx-4 mt-3 flex items-center justify-between gap-2 p-3 rounded-xl bg-warning-surface border border-warning/30 text-caption text-warning-foreground"
      role="status"
    >
      <span>{message}</span>
      {/*
