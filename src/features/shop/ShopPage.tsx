...
const PRODUCTS: readonly ShopProduct[] = [
  {
    id: 'sticker-daily',
    title: '군화·곰신 일상 스티커 팩',
    category: 'stickers',
    categoryLabel: '스티커',
    description: '훈련소, 전화 시간, 첫 휴가, 복귀날 등 우리만의 특별한 일상을 따뜻하게 남기는 24종 다꾸 스티커 팩입니다.',
    statusBadge: '준비 중',
    previewItems: ['전화', '편지', '하트', '휴가'],
    highlights: ['24종 손그림 감성 일러스트', '기록 지면에 자유롭게 배치', '기본 무료 스티커와 함께 사용 가능'],
  },
  {
    id: 'sticker-seasons',
    title: '사계절 감성 스티커 팩',
    category: 'stickers',
    categoryLabel: '스티커',
    description: '봄 벚꽃, 여름 바다, 가을 낙엽, 겨울 눈꽃까지 계절의 흐름을 지면 가득 담을 수 있는 사계절 스티커 팩입니다.',
    statusBadge: '준비 중',
    previewItems: ['벚꽃', '파도', '단풍', '눈꽃'],
    highlights: ['사계절 대표 모티브 20종', '계절별 테마 다이어리에 최적화'],
  },
  {
    id: 'sticker-craft',
    title: '빈티지 마스킹 테이프 & 스탬프',
    category: 'stickers',
    categoryLabel: '스티커',
    description: '크라프트 종이 테이프, 우표 스탬프, 포스트잇 느낌으로 손수 꾸민 듯한 감성을 더해주는 소품 스티커 팩입니다.',
    statusBadge: '준비 중',
    previewItems: ['테이프', '스탬프', '클립', '라벨'],
    highlights: ['종이 질감 오브젝트 16종', '실제 다꾸 느낌의 스탬프 효과'],
  },
  {
    id: 'theme-kraft',
    title: '빈티지 크라프트지 테마',
    category: 'themes',
    categoryLabel: '다꾸 테마',
    description: '따뜻하고 바스락거리는 크라프트 종이 질감과 잉크 펜 촉감이 어우러진 클래식 다이어리 테마입니다.',
    statusBadge: '준비 중',
  ...
  },
  {
    ...
    category: 'themes',
    categoryLabel: '다꾸 테마',
    description: '은은한 파스텔 톤 모눈 괘선과 부드러운 산호빛이 어우러져 화사하고 포근한 분위기를 주는 테마입니다.',
    statusBadge: '준비 중',
  ...
  },
  {
    ...
    category: 'themes',
    categoryLabel: '다꾸 테마',
    description: '군더더기 없는 정갈한 흑백 잉크와 단정한 괘선으로 오직 기록의 문장에만 집중할 수 있는 테마입니다.',
    statusBadge: '준비 중',
    highlights: ['단정한 모노크롬 괘선', '가독성 중심 레이아웃', '흑백 인쇄 감성'],
  },
  {
    id: 'book-monthly',
    title: '우리의 한 달 기억책 (실물 & 디지털)',
    category: 'books',
    categoryLabel: '책 만들기',
    description: '한 달 동안 남긴 소중한 기록과 사진을 따로 정리할 필요 없이 앱이 한 권의 아름다운 포토 에세이북으로 엮어 배송해 드려요.',
    statusBadge: 'P-MP 게이트 준비 중',
    highlights: [
      '정리 부담 0% — 자동 포토북 엮음',
      '고화질 사진과 손글씨 기록 인쇄',
      '디지털 PDF 소장본 & 실물 양장본 선택 가능',
    ],
  },
  {
    id: 'book-milestone',
    title: '100일 · 1주년 기념 앨범',
    category: 'books',
    categoryLabel: '책 만들기',
    description: '첫날부터 기념일까지 둘만의 특별한 마일스톤 순간들을 모아 평생 간직할 수 있는 프리미엄 하드커버 앨범으로 제작합니다.',
    statusBadge: 'P-MP 게이트 준비 중',
    highlights: ['마일스톤 중심 타임라인 하이라이트', '프리미엄 하드커버 패키징', '선물용 맞춤 각인 커버'],
  },
] as const;
