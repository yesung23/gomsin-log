...
const TodayBriefingWidget = () => {
  ...
  return (
    <div className="bg-card p-4 rounded-2xl border border-border shadow-sm">
      <h3 className="font-bold text-foreground mb-2 text-sm">오늘의 브리핑</h3>
...
const ServiceProgressWidget = () => (
  <div className="bg-card p-4 rounded-2xl border border-border shadow-sm">
    <h3 className="font-bold text-foreground mb-2 text-sm">복무 진행률</h3>
    <div className="w-full bg-muted h-3 rounded-full overflow-hidden">
      <div className="bg-teal-500 h-full w-[45%]"></div>
    </div>
    <div className="mt-2 text-right text-[10px] text-muted-foreground">45% 진행됨</div>
  </div>
);
...
const TodayMealWidget = () => (
  <div className="bg-card p-4 rounded-2xl border border-border shadow-sm">
    <h3 className="font-bold text-foreground mb-2 text-sm">오늘의 식단 🍚</h3>
    <p className="text-xs text-muted-foreground">제육볶음, 된장찌개, 김치</p>
  </div>
);
...
const NextAnniversaryWidget = () => (
  <div className="bg-card p-4 rounded-2xl border border-border shadow-sm flex items-center gap-3">
    ...
    <div>
      <h3 className="font-bold text-foreground text-sm">1주년</h3>
      <p className="text-xs text-muted-foreground">D-45</p>
    </div>
  </div>
);
...
const NextVacationWidget = () => (
  <div className="bg-card p-4 rounded-2xl border border-border shadow-sm flex items-center gap-3">
    ...
    <div>
      <h3 className="font-bold text-foreground text-sm">첫 휴가</h3>
      <p className="text-xs text-muted-foreground">D-12</p>
    </div>
  </div>
);
...
const MemoriesWidget = () => (
  <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-4 rounded-2xl border border-white shadow-sm min-h-[120px] flex flex-col justify-end">
    <h3 className="font-bold text-foreground text-sm">1년 전 오늘 📸</h3>
  </div>
);
