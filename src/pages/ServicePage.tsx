        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div role="dialog" aria-modal="true" aria-labelledby="service-edit-modal-title" className="bg-card border border-border w-full max-w-md rounded-surface p-6 shadow-xl space-y-4 max-h-[90dvh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="svc-status" className="block text-label font-semibold text-muted-foreground mb-1">
                  복무 상태
                </label>
                <select
                  id="svc-status"
              ...
              <div>
                <label htmlFor="svc-branch" className="block text-label font-semibold text-muted-foreground mb-1">
                  군종
                </label>
                <select
                  id="svc-branch"
              ...
              {editStatus !== 'unknown' && (
                <>
                  <div>
                    <label htmlFor="svc-enlist" className="block text-label font-semibold text-muted-foreground mb-1">
                      입대일
                    </label>
                    <input
                      id="svc-enlist"
                  ...
                  <div>
                    <label htmlFor="svc-discharge" className="block text-label font-semibold text-muted-foreground mb-1">
                      예상 전역일
                    </label>
                    <input
                      id="svc-discharge"
