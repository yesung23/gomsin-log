...
| `041_chat_messages_e2ee.sql` | 04A. V1 텍스트 채팅의 여섯 개 서버 필드, CSK/GLE1 ciphertext, ACTIVE epoch 검사, per-couple ordinal, sender-only irreversible tombstone, RLS | **신규 / 어디에도 미적용** |
