...
> 가장 나쁜 방향입니다.
>
> 현재 사실: 001→…→047→048→049→050→051이 한 체인이고, 빈 PostgreSQL 17.10에 49개가
> 순서대로 적용되며 212개 assertion이 통과합니다.
...
| `052_unseen_flag_survives_no_record.sql` | 공유 기록이 **삭제**될 때(계정 탈퇴의 CASCADE 포함) 파트너의 알림 플래그를 내린다 — 048/051이 다루지 않은 경로 | **운영 미적용** |
